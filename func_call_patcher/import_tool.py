...
class ImportTool:
    ...
    @classmethod
    def _import_class_and_method_from_string(cls, path_to_func: str) -> Tuple[Type, Callable]:
    ...
    @classmethod
    def _import_func_from_string(cls, path_to_func: str) -> Callable:
        path_to_func_splitted = path_to_func.split('.')
    ...
    def import_func_from_string(cls, path_to_func: str) -> Callable:
        try:
            return cls._import_func_from_string(path_to_func=path_to_func)
        except Exception:
            cls._raise_it_cannot_be_imported_error(path_to_func=path_to_func)
